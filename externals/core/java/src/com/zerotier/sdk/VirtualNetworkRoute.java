 ...
 */
public class VirtualNetworkRoute implements Comparable<com.zerotier.sdk.VirtualNetworkRoute> {
    /**
    ...
    @Override
    public int compareTo(com.zerotier.sdk.VirtualNetworkRoute other) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.zerotier.sdk.VirtualNetworkRoute)) {
            return false;
        }

        com.zerotier.sdk.VirtualNetworkRoute other = (com.zerotier.sdk.VirtualNetworkRoute) o;
