 ...
 */
public class VirtualNetworkDNS implements Comparable<com.zerotier.sdk.VirtualNetworkDNS> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.zerotier.sdk.VirtualNetworkDNS)) {
            return false;
        }

        com.zerotier.sdk.VirtualNetworkDNS d = (com.zerotier.sdk.VirtualNetworkDNS) o;
    ...
    @Override
    public int compareTo(com.zerotier.sdk.VirtualNetworkDNS o) {
