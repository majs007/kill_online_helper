 ...
 */
public class VirtualNetworkConfig implements Comparable<com.zerotier.sdk.VirtualNetworkConfig> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.zerotier.sdk.VirtualNetworkConfig)) {
            Log.i(TAG, "Old is not an instance of VirtualNetworkConfig: " + o);

            return false;
        }

        com.zerotier.sdk.VirtualNetworkConfig old = (com.zerotier.sdk.VirtualNetworkConfig) o;
    ...
    @Override
    public int compareTo(com.zerotier.sdk.VirtualNetworkConfig cfg) {
