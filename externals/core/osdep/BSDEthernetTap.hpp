...
namespace ZeroTier {
    ...
    public:
        ...
        virtual void put(const MAC &from, const MAC &to, unsigned int etherType, const void *data,
                         unsigned int len);
        ...
        virtual void scanMulticastGroups(std::vector<MulticastGroup> &added,
    ...
    private:
        void
        (*_handler)(void *, void *, uint64_t, const MAC &, const MAC &, unsigned int, unsigned int,
