 ...
 */
    ...
    public:
         ...
         */
        void onRemotePacket(void *tPtr, const int64_t localSocket, const InetAddress &fromAddr,
         ...
         */
        void onLocalEthernet(void *tPtr, const SharedPtr<Network> &network, const MAC &from,
         ...
         */
        void
        aqm_enqueue(void *tPtr, const SharedPtr<Network> &network, Packet &packet, bool encrypt,
                    int qosBucket, int32_t flowId = ZT_QOS_NO_FLOW);
    ...
    private:
        ...
        bool _trySend(void *tPtr, Packet &packet, bool encrypt,
                      int32_t flowId = ZT_QOS_NO_FLOW); // packet is modified if return is true
        void _sendViaSpecificPath(void *tPtr, SharedPtr<Peer> peer, SharedPtr<Path> viaPath,
