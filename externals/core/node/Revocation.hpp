 ...
 */
    ...
    public:
        ...
        credentialType() { return Credential::CREDENTIAL_TYPE_REVOCATION; }
         ...
         */
        Revocation(const uint32_t i, const uint64_t nwid, const uint32_t cid, const int64_t thr,
                   const uint64_t fl, const Address &tgt, const Credential::Type ct) :
                _id(i),
                _credentialId(cid),
                _networkId(nwid),
                _threshold(thr),
