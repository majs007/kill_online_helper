 ...
 */
    ...
    public:
         ...
         */
        static void
        agree(const Private &mine, const Public &their, void *keybuf, unsigned int keylen);

        static inline void
        agree(const Pair &mine, const Public &their, void *keybuf, unsigned int keylen) {
         ...
         */
        static void
        sign(const Private &myPrivate, const Public &myPublic, const void *msg, unsigned int len,
             void *signature);

        static inline void
        sign(const Pair &mine, const void *msg, unsigned int len, void *signature) {
         ...
         */
        static bool
        verify(const Public &their, const void *msg, unsigned int len, const void *signature);
         ...
         */
        static inline bool
        verify(const Public &their, const void *msg, unsigned int len, const Signature &signature) {
