 ...
 */
    ...
    public:
         ...
         */
        inline void add(void *tPtr, int64_t now, uint64_t nwid, const MulticastGroup &mg,
         ...
         */
        void addMultiple(void *tPtr, int64_t now, uint64_t nwid, const MulticastGroup &mg,
         ...
         */
        unsigned int gather(const Address &queryingPeer, uint64_t nwid, const MulticastGroup &mg,
         ...
         */
        std::vector<Address>
        getMembers(uint64_t nwid, const MulticastGroup &mg, unsigned int limit) const;
    ...
    private:
        ...
        void _add(void *tPtr, int64_t now, uint64_t nwid, const MulticastGroup &mg,
