 ...
 */
    ...
    public:
         ...
         */
        Peer(const RuntimeEnvironment *renv, const Identity &myIdentity,
         ...
         */
        inline bool
        sendDirect(void *tPtr, const void *data, unsigned int len, int64_t now, bool force) {
         ...
         */
        void
        sendHELLO(void *tPtr, const int64_t localSocket, const InetAddress &atAddress, int64_t now);
         ...
         */
        void attemptToContactAt(void *tPtr, const int64_t localSocket, const InetAddress &atAddress,
         ...
         * @param now Current time
         */
        void clusterRedirect(void *tPtr, const SharedPtr<Path> &originatingPath,
         ...
         * @param now Current time
         */
        void resetWithinScope(void *tPtr, InetAddress::IpScope scope, int inetAddressFamily,
                              int64_t now);
         ...
         * @param vrev Revision
         */
        inline void setRemoteVersion(unsigned int vproto, unsigned int vmaj, unsigned int vmin,
                                     unsigned int vrev) {
        ...
        template<unsigned int C>
        inline static SharedPtr<Peer> deserializeFromCache(int64_t now, void *tPtr, Buffer<C> &b,
        ...
        inline const AES *aesKeys() const { return _aesKeys; }
...
namespace std {
    template<>
    inline void
    swap(ZeroTier::SharedPtr<ZeroTier::Peer> &a, ZeroTier::SharedPtr<ZeroTier::Peer> &b) {
        a.swap(b);
    }
}
