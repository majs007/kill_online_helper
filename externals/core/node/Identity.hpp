 ...
 */
    ...
    public:
        ...
        Identity(const Identity &id) :
                ...
                _privateKey((id._privateKey) ? new C25519::Private(*(id._privateKey))
                                             : (C25519::Private *) 0) {
        }
        ...
        inline void publicKeyHash(void *sha384buf) const {
            ...
            SHA384(sha384buf, address, ZT_ADDRESS_LENGTH, _publicKey.data,
         ...
         */
        inline bool verify(const void *data, unsigned int len, const void *signature,
         ...
         */
        inline bool
        verify(const void *data, unsigned int len, const C25519::Signature &signature) const {
            return C25519::verify(_publicKey, data, len, signature);
        }
        ...
        inline unsigned int deserialize(const Buffer<C> &b, unsigned int startAt = 0) {
            ...
            if (privateKeyLength) {
                ...
                _privateKey = new C25519::Private();
                memcpy(_privateKey->data, b.field(p, ZT_C25519_PRIVATE_KEY_LEN),
        ...
        inline bool operator==(const Identity &id) const { return ((_address == id._address) &&
                                                                   (memcmp(_publicKey.data,
                                                                           id._publicKey.data,
                                                                           ZT_C25519_PUBLIC_KEY_LEN) ==
                                                                    0));
        }
