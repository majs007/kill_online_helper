    ...
    public:
        ...
        static inline bool secureEq(const void *a, const void *b, unsigned int len) {
            ...
            for (unsigned int i = 0; i < len; ++i) {
                diff |= ((reinterpret_cast<const uint8_t *>(a))[i] ^
        ...
        unhex(const char *h, unsigned int hlen, void *buf, unsigned int buflen) {
            unsigned int l = 0;
        ...
        static inline float
        normalize(float value, float bigMin, float bigMax, float targetMin, float targetMax) {
        ...
        public:
            static ZT_INLINE I l(const uint8_t *const p) noexcept {
                return (I) (((uint32_t) p[0] << 24U) | ((uint32_t) p[1] << 16U) |
        ...
        public:
            static ZT_INLINE I l(const uint8_t *const p) noexcept {
                return (I) (((uint64_t) p[0] << 56U) | ((uint64_t) p[1] << 48U) |
        ...
        public:
            static ZT_INLINE I l(const uint8_t *const p) noexcept {
                return (I) ((uint32_t) p[0] | ((uint32_t) p[1] << 8U) | ((uint32_t) p[2] << 16U) |
                            ((uint32_t) p[3] << 24U));
            }
        };
        ...
        public:
            static ZT_INLINE I l(const uint8_t *const p) noexcept {
                return (I) ((uint64_t) p[0] | ((uint64_t) p[1] << 8U) | ((uint64_t) p[2] << 16U) |
                            ((uint64_t) p[3] << 24U) | ((uint64_t) p[4] << 32U) | ((uint64_t) p[5]
                        << 40U) | ((uint64_t) p[6] << 48U) | ((uint64_t) p[7]) << 56U);
            }
        };
