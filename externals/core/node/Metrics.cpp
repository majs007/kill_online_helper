...
namespace ZeroTier {
    namespace Metrics {
        ...
        prometheus::simpleapi::counter_metric_t pkt_error_internal_server_error_in
                {packet_errors.Add({{"error_type", "internal_server_error"},
                                    {"direction",  "rx"}})};
        ...
        prometheus::simpleapi::gauge_family_t network_num_multicast_groups
                {"zt_network_multicast_groups_subscribed",
                 "number of multicast groups networks are subscribed to"};
        ...
        prometheus::simpleapi::counter_metric_t network_changes
                {"controller_network_change_count",
                 "number of times a network configuration is changed"};
        prometheus::simpleapi::counter_metric_t member_changes
                {"controller_member_change_count",
                 "number of times a network member configuration is changed"};
        ...
        prometheus::simpleapi::gauge_metric_t network_config_request_queue_size
                {"controller_network_config_request_queue",
                 "number of entries in the request queue for network configurations"};
        ...
        prometheus::simpleapi::gauge_metric_t network_config_request_threads
                {"controller_network_config_request_threads",
                 "number of active network config handling threads"};
