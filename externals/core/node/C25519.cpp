...
/* Assumes input x being reduced below 2^255 */
    ...
    static const crypto_uint32 m[32] = {0xED, 0xD3, 0xF5, 0x5C, 0x1A, 0x63, 0x12, 0x58, 0xD6, 0x9C,
                                        0xF7, 0xA2, 0xDE, 0xF9, 0xDE, 0x14, 0x00, 0x00, 0x00, 0x00,
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                        0x00, 0x10};
    static const crypto_uint32 mu[33] = {0x1B, 0x13, 0x2C, 0x0A, 0xA3, 0xE5, 0x9C, 0xED, 0xA7, 0x29,
                                         0x63, 0x08, 0x5D, 0x21, 0x06, 0x21, 0xEB, 0xFF, 0xFF, 0xFF,
...
/* Reduce coefficients of x before calling barrett_reduce */
    ...
    static inline void
    sc25519_2interleave2(unsigned char r[127], const sc25519 *s1, const sc25519 *s2) {
        int i;
        for (i = 0; i < 31; i++) {
...
/* d */
    static const fe25519 ge25519_ecd = {
            {0xA3, 0x78, 0x59, 0x13, 0xCA, 0x4D, 0xEB, 0x75, 0xAB, 0xD8, 0x41, 0x41, 0x4D, 0x0A,
             0x70, 0x00,
             0x98, 0xE8, 0x79, 0x77, 0x79, 0x40, 0xC7, 0x8C, 0x73, 0xFE, 0x6F, 0x2B, 0xEE, 0x6C,
             0x03, 0x52}};
/* 2*d */
    static const fe25519 ge25519_ec2d = {
            {0x59, 0xF1, 0xB2, 0x26, 0x94, 0x9B, 0xD6, 0xEB, 0x56, 0xB1, 0x83, 0x82, 0x9A, 0x14,
             0xE0, 0x00,
             0x30, 0xD1, 0xF3, 0xEE, 0xF2, 0x80, 0x8E, 0x19, 0xE7, 0xFC, 0xDF, 0x56, 0xDC, 0xD9,
             0x06, 0x24}};
/* sqrt(-1) */
    static const fe25519 ge25519_sqrtm1 = {
            {0xB0, 0xA0, 0x0E, 0x4A, 0x27, 0x1B, 0xEE, 0xC4, 0x78, 0xE4, 0x2F, 0xAD, 0x06, 0x18,
             0x43, 0x2F,
             0xA7, 0xD7, 0xFB, 0x3D, 0x99, 0x00, 0x4D, 0x2B, 0x0B, 0xDF, 0xC1, 0x4F, 0x80, 0x24,
             0x83, 0x2B}};
...
/* computes [s1]p1 + [s2]p2 */
    static inline void
    ge25519_double_scalarmult_vartime(ge25519_p3 *r, const ge25519_p3 *p1, const sc25519 *s1,
                                      const ge25519_p3 *p2, const sc25519 *s2) {
        ge25519_p1p1 tp1p1;
        ge25519_p3 pre[16];
    ...
    static inline void
    get_hram(unsigned char *hram, const unsigned char *sm, const unsigned char *pk,
...
namespace ZeroTier {
    ...
    void C25519::agree(const C25519::Private &mine, const C25519::Public &their, void *keybuf,
                       unsigned int keylen) {
    ...
    void
    C25519::sign(const C25519::Private &myPrivate, const C25519::Public &myPublic, const void *msg,
                 unsigned int len, void *signature) {
    ...
    bool C25519::verify(const C25519::Public &their, const void *msg, unsigned int len,
