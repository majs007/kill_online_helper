...
namespace prometheus {
    ...
    class TextSerializer {
...
#else
                int wouldHaveWritten = std::snprintf(buffer.data(), buffer.size(), "%.*g",
        ...
        static void SerializeCounter(std::ostream &out, const MetricFamily &family,
                                     const ClientMetric &metric) {
        ...
        static void
        SerializeGauge(std::ostream &out, const MetricFamily &family, const ClientMetric &metric) {
            WriteHead(out, family, metric);
            WriteValue(out, metric.gauge.value);
            WriteTail(out, metric);
        }

        static void SerializeSummary(std::ostream &out, const MetricFamily &family,
                                     const ClientMetric &metric) {
        ...
        static void SerializeUntyped(std::ostream &out, const MetricFamily &family,
                                     const ClientMetric &metric) {
            WriteHead(out, family, metric);
        ...
        static void SerializeHistogram(std::ostream &out, const MetricFamily &family,
                                       const ClientMetric &metric) {
