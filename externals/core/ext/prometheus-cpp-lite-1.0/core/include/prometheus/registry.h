...
namespace prometheus {
    ...
    public:
        ...
        CustomFamily &
        Add(const std::string &name, const std::string &help, const Family::Labels &labels) {
            ...
            for (const FamilyPtr &family_ptr: families) {
                if (family_ptr->GetName() == name) {
                    ...
                    if (family_ptr->type !=
                        CustomFamily::static_type) // found family with this name and with different type
