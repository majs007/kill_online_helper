...
namespace prometheus {
    ...
    public:
        ...
        Family(Metric::Type type_, const std::string &name_, const std::string &help_,
    ...
    public:
        ...
        CustomFamily(const std::string &name, const std::string &help,
                     const Family::Labels &constant_labels)
        ...
        static CustomFamily &
        Build(Registry &registry, const std::string &name, const std::string &help,
