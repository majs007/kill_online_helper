    ...
    namespace redis {
        ...
        public:
            Redis(const ConnectionOptions &connection_opts,
                  const ConnectionPoolOptions &pool_opts = {}) : _pool(pool_opts,
                                                                       connection_opts) {}
            ...
            Redis(const std::shared_ptr<Sentinel> &sentinel,
                  ...
                  const ConnectionPoolOptions &pool_opts = {}) :
                    _pool(SimpleSentinel(sentinel, master_name, role), pool_opts,
                          connection_opts) {}
        ...
        private:
            ...
            public:
                ConnectionPoolGuard(ConnectionPool &pool,
                                    Connection &connection) : _pool(pool),
            ...
            ReplyUPtr
            _command(const StringView &cmd_name, const IndexSequence<Is...> &, Args &&...args) {
