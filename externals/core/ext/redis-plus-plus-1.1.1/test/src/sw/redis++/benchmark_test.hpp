    ...
    namespace redis {
        ...
        namespace test {
            ...
            BenchmarkTest<RedisInstance>::BenchmarkTest(const BenchmarkOptions &opts,
                                                        RedisInstance &instance) : _opts(opts),
                                                                                   _redis(instance) {
            ...
            void BenchmarkTest<RedisInstance>::run() {
                ...
                _run("SET key value",
                     [this](std::size_t idx) { this->_redis.set(this->_key(idx), _value); });
            ...
            void BenchmarkTest<RedisInstance>::_run(const std::string &title, Func &&func) {
                ...
                res.push_back(std::async(std::launch::async,
                                         [this](Func &&func, std::size_t request_num) {
                                             return this->_run(std::forward<Func>(func),
                                                               request_num);
                                         },
                ...
                std::cout << total_request_num << " requests cost " << total_in_sec << " seconds"
                          << std::endl;
