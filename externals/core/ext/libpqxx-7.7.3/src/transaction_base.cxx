...
pqxx::transaction_base::quote_raw(zview
bin) const
{
return
 ...
 */
    class PQXX_PRIVATE command

    : pqxx::transaction_focus {
    public:
    command(pqxx::transaction_base
    &tx,
...
void pqxx::transaction_base::register_pending_error(zview
err) noexcept
{
if (
std::empty(m_pending_error)
and not
std::empty(err)
)
{
