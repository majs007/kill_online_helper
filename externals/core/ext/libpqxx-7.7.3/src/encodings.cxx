...
// https://en.wikipedia.org/wiki/Big5#Organization
    ...
    glyph_scanner<encoding_group::BIG5>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
...
// https://en.wikipedia.org/wiki/GB_2312#EUC-CN
    ...
    glyph_scanner<encoding_group::EUC_CN>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
    ...
    glyph_scanner<encoding_group::EUC_JP>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
...
// https://en.wikipedia.org/wiki/Extended_Unix_Code#EUC-KR
    ...
    glyph_scanner<encoding_group::EUC_KR>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
...
// https://en.wikipedia.org/wiki/Extended_Unix_Code#EUC-TW
    ...
    glyph_scanner<encoding_group::EUC_TW>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            PQXX_UNLIKELY
            return std::string::npos;
...
// https://en.wikipedia.org/wiki/GB_18030#Mapping
    ...
    glyph_scanner<encoding_group::GB18030>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
...
// https://en.wikipedia.org/wiki/GBK_(character_encoding)#Encoding
    ...
    glyph_scanner<encoding_group::GBK>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
...
*/
    ...
    glyph_scanner<encoding_group::JOHAB>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
...
*/
    ...
    glyph_scanner<encoding_group::SJIS>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
...
// https://en.wikipedia.org/wiki/Unified_Hangul_Code
    ...
    glyph_scanner<encoding_group::UHC>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
...
// https://en.wikipedia.org/wiki/UTF-8#Description
    ...
    glyph_scanner<encoding_group::UTF8>::call(
            char const buffer[], std::size_t buffer_len, std::size_t start) {
        if (start >= buffer_len)
            return std::string::npos;
 ...
 */
    ...
    constexpr inline F *for_encoding(encoding_group
    enc) {
...
{
return
for_encoding<glyph_scanner, glyph_scanner_func>(enc);
}


template<encoding_group E>
struct char_finder {
    constexpr static PQXX_PURE std::size_t
    call(std::string_view
    haystack, char needle, std::size_t
    start)
    {
...
struct string_finder {
    PQXX_PURE constexpr static PQXX_PURE
