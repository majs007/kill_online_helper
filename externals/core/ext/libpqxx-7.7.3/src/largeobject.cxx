...
namespace {
    constexpr inline int PQXX_COLD
    std_mode_to_pq_mode(std::ios::openmode
    mode) {
...
constexpr int PQXX_COLD
std_dir_to_pq_dir(std::ios::seekdir
dir) noexcept
{
if constexpr (
static_cast
...
void PQXX_COLD
pqxx::largeobject::to_file(dbtransaction
&t,
...
lo_export(raw_connection(t), id(), std::data(file)
...
void PQXX_COLD
pqxx::largeobject::remove(dbtransaction
&t) const
{
if (
...
throw failure{
internal::concat(
"Could not delete large object ", m_id, ": ",
reason(t
.
...
pqxx::largeobject::raw_connection(dbtransaction
const &t)
{
...
pqxx::largeobject::reason(connection
const &c,
int err
) const
{
...
return pqxx::internal::gate::const_connection_largeobject{
c}.
...
PQXX_COLD
        pqxx::largeobjectaccess::largeobjectaccess(dbtransaction & t, openmode
mode) :
largeobject{
t}, m_trans{
t}
...
PQXX_COLD pqxx::largeobjectaccess::largeobjectaccess(
        dbtransaction & t, std::string_view
file,
openmode mode
) :
largeobject{
...
pqxx::largeobjectaccess::seek(size_type
dest,
seekdir dir
)
{
...
"No object selected."};
throw failure{
internal::concat("Error seeking in large object: ",
reason(err)
)};
}
...
pqxx::largeobjectaccess::cseek(off_type
dest,
seekdir dir
) noexcept
{
...
lo_lseek64(raw_connection(), m_fd, dest, std_dir_to_pq_dir(dir)
...
void PQXX_COLD
pqxx::largeobjectaccess::open(openmode
mode)
{
if (
...
pqxx::largeobjectaccess::close() noexcept {
    if (m_fd >= 0)
...
pqxx::largeobjectaccess::reason(int err) const {
    if (m_fd == -1)
...
void PQXX_COLD
pqxx::largeobjectaccess::process_notice(zview
s) noexcept
{
m_trans.
process_notice(s);
