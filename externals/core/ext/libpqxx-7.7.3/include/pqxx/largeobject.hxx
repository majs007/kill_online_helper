 ...
 */
    class PQXX_LIBEXPORT largeobjectaccess
    ...
    largeobjectaccess(largeobjectaccess
    const &) = delete;

    largeobjectaccess operator=(largeobjectaccess const &) = delete;

    private:
    PQXX_PRIVATE std::string

    reason(int err) const;
