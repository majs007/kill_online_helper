 ...
 * instead.
 */
    class PQXX_LIBEXPORT sql_cursor
    ...
    cname,
    cursor_base::access_policy ap, cursor_base::update_policy
    up,
...
obtain_stateless_cursor_size(sql_cursor
&);
