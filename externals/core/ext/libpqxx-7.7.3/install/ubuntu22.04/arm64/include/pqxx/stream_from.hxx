 ...
 * time.
 */
    class PQXX_LIBEXPORT stream_from
...
[[deprecated("Use the from_table_t overload instead.")]] stream_from(
        transaction_base
&tx,
std::string_view table, Columns
const &columns) :
stream_from{
tx, from_table, table, columns}
{
}
...
stream_from(
        transaction_base
&tx,
std::string_view table, std::string_view
columns,
from_table_t);
...
stream_from(
        transaction_base
&,
std::string_view unquoted_table,
        std::string_view
columns, from_table_t, int);
...
inline stream_from::stream_from(
        transaction_base & tx, from_table_t, std::string_view
table_name,
Columns const &columns
) :
stream_from{
tx, from_table, table_name,
