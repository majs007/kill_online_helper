...
#include "pqxx/internal/ignore-deprecated-pre.hxx"
    ...
    const_result_iterator(row
    const &t) noexcept : row {
    t
}
{
}
...
const_result_iterator(pqxx::result
const *r,
result_size_type i
) noexcept :
row{
...
/// Copy an iterator.
const_reverse_result_iterator(const_reverse_result_iterator
const &rhs) =
default;
...
[[nodiscard]] PQXX_PURE const_result_iterator
...
void swap(const_reverse_result_iterator & other)
noexcept
{
