                    ...
                    void check_size(size_type expected) const
                    {
                        if (size() != expected)
                            throw usage_error{internal::concat(
                                    "Tried to extract ", expected, " field(s) from a row of ",
                                    size(),
                                    ".")};
                    }
...
#include "pqxx/internal/ignore-deprecated-post.hxx"
    ...
    const_row_iterator(row
    const &t,
    row_size_type c
    ) noexcept :
    field {
    t.m_result, t.m_index, c
}
{
}
const_row_iterator(field
const &F) noexcept : field{
F} {
}
...
const_row_iterator &operator=(const_row_iterator && )
noexcept = default;
...
class PQXX_LIBEXPORT const_reverse_row_iterator
...
const_reverse_row_iterator(const_reverse_row_iterator
const &) noexcept =
default;
const_reverse_row_iterator(const_reverse_row_iterator
&&) noexcept = default;

explicit const_reverse_row_iterator(super
const &rhs) noexcept :
const_row_iterator{
rhs}
{
...
[[nodiscard]] PQXX_PURE iterator_type
