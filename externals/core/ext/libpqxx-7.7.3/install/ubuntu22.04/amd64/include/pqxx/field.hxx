    ...
    class PQXX_LIBEXPORT field
            {
                     ...
                     */
                    template<typename T,
                    template<typename> class O = std::optional>
 ...
 */
    template<>
    inline bool field::to<char const *>(char const *&obj) const {
        bool const null{is_null()};
        if (not null)
            obj = c_str();
        return not null;
    ...
    template<>
    inline bool field::to<std::string_view>(std::string_view &obj) const {
        bool const null{is_null()};
        if (not null)
            obj = view();
        return not null;
    ...
    template<>
    inline bool field::to<zview>(zview &obj) const {
        bool const null{is_null()};
        if (not null)
    ...
    template<>
    inline zview field::as<zview>() const {
        if (is_null())
            PQXX_UNLIKELY
    ...
    template<>
    inline zview field::as<zview>(zview const &default_value) const {
 ...
 */
    template<typename T>
    inline T from_string(field const &value) {
        if (value.is_null()) {
...
/// Convert a field to a string.
    template<> PQXX_LIBEXPORT std::string
    to_string(field
    const &value);
} // namespace pqxx
#endif
