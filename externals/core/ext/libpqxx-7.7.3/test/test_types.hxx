...
namespace pqxx {
    template<>
    struct nullness<std::byte> : no_null<std::byte> {
    };
...
namespace pqxx {
    template<>
    struct nullness<ipv4> : no_null<ipv4> {
    };


    template<>
    struct string_traits<ipv4> {
    ...
    template<>
    struct nullness<bytea> : no_null<bytea> {
    };


    template<>
    struct string_traits<bytea> {
