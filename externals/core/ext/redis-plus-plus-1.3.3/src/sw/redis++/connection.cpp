...
namespace sw {
    ...
    namespace redis {
        ...
        ConnectionOptions::_parse_timeout_option(const std::string &str) const {
        ...
        void
        ConnectionOptions::_set_auth_opts(const std::string &auth, ConnectionOptions &opts) const {
            if (auth.empty()) {
                // No auth info.
                return;
            }
        ...
        void
        ConnectionOptions::_set_tcp_opts(const std::string &path, ConnectionOptions &opts) const {
        ...
        void
        ConnectionOptions::_set_unix_opts(const std::string &path, ConnectionOptions &opts) const {
