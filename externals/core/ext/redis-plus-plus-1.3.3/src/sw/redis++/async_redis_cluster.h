...
namespace sw {
    ...
    namespace redis {
        ...
        public:
            ...
            Future <Result>
            command(const StringView &cmd_name, const StringView &key, Args &&...args) {
            ...
            -> typename std::enable_if<IsIter<Input>::value, Future < Result>>
            ...
            Future<double>
            hincrbyfloat(const StringView &key, const StringView &field, double increment) {
            ...
            Future<bool>
            hset(const StringView &key, const StringView &field, const StringView &val) {
            ...
            Future <OptionalString> spop(const StringView &key) {
                return _command < OptionalString, FormattedCommand(*)(
                const StringView &)>(fmt::spop, key);
            }
            ...
            Future <Output> spop(const StringView &key, long long count) {
                return _command < Output,
                        FormattedCommand(*)(
                const StringView &, long long)>(fmt::spop, key, count);
            }
            ...
            Future<double>
            zincrby(const StringView &key, double increment, const StringView &member) {
            ...
            Future <Optional<std::pair<std::string, double>>> zpopmax(const StringView &key) {
                ...
                FormattedCommand(*)(
                const StringView &)>(fmt::zpopmax, key);
            }

            template<typename Output>
            Future <Output> zpopmax(const StringView &key, long long count) {
                return _command < Output, FormattedCommand(*)(
                const StringView &, long long)>(
            ...
            Future <Optional<std::pair<std::string, double>>> zpopmin(const StringView &key) {
                return _command < Optional < std::pair<std::string, double>>,
                FormattedCommand(*)(
                const StringView &)>(fmt::zpopmin, key);
            }
        ...
        private:
            ...
            Future <Result>
            _generic_command(Formatter formatter, const StringView &key, Args &&...args) {
            ...
            Future <Result>
            _generic_command(Formatter formatter, std::false_type, Input &&input, Args &&...args) {
