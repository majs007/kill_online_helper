...
namespace sw {
    ...
    namespace redis {
        ...
        Transaction
        RedisCluster::transaction(const StringView &hash_tag, bool piped, bool new_connection) {
            auto pool = _pool.fetch(hash_tag);
            if (new_connection) {
                // Create a new pool
                pool = std::make_shared<ConnectionPool>(pool->clone());
...
// STRING commands.
        ...
        long long
        RedisCluster::bitop(BitOp op, const StringView &destination, const StringView &key) {
        ...
        long long
        RedisCluster::setrange(const StringView &key, long long offset, const StringView &val) {
...
// LIST commands.
        ...
        OptionalStringPair
        RedisCluster::blpop(const StringView &key, const std::chrono::seconds &timeout) {
        ...
        OptionalStringPair
        RedisCluster::brpop(const StringView &key, const std::chrono::seconds &timeout) {
        ...
        long long
        RedisCluster::lrem(const StringView &key, long long count, const StringView &val) {
        ...
        OptionalString
        RedisCluster::rpoplpush(const StringView &source, const StringView &destination) {
        ...
        long long
        RedisCluster::hincrby(const StringView &key, const StringView &field, long long increment) {
            auto reply = command(cmd::hincrby, key, field, increment);

            return reply::parse<long long>(*reply);
        }

        double RedisCluster::hincrbyfloat(const StringView &key, const StringView &field,
                                          double increment) {
        ...
        bool
        RedisCluster::hset(const StringView &key, const StringView &field, const StringView &val) {
        ...
        bool
        RedisCluster::hset(const StringView &key, const std::pair<StringView, StringView> &item) {
            return hset(key, item.first, item.second);
        }

        bool RedisCluster::hsetnx(const StringView &key, const StringView &field,
                                  const StringView &val) {
        ...
        bool
        RedisCluster::hsetnx(const StringView &key, const std::pair<StringView, StringView> &item) {
...
// SORTED SET commands.
        ...
        double
        RedisCluster::zincrby(const StringView &key, double increment, const StringView &member) {
        ...
        long long
        RedisCluster::zremrangebyrank(const StringView &key, long long start, long long stop) {
...
// Stream commands.
        ...
        long long
        RedisCluster::xack(const StringView &key, const StringView &group, const StringView &id) {
