...
// LIST commands.
        ...
        OptionalStringPair
        Redis::blpop(const StringView &key, const std::chrono::seconds &timeout) {
        ...
        OptionalStringPair
        Redis::brpop(const StringView &key, const std::chrono::seconds &timeout) {
        ...
        long long
        Redis::hincrby(const StringView &key, const StringView &field, long long increment) {
        ...
        double
        Redis::hincrbyfloat(const StringView &key, const StringView &field, double increment) {
...
// SORTED SET commands.
        ...
        long long
        Redis::zinterstore(const StringView &destination, const StringView &key, double weight) {
        ...
        long long
        Redis::zunionstore(const StringView &destination, const StringView &key, double weight) {
...
// GEO commands.
        ...
        Redis::geopos(const StringView &key, const StringView &member) {
...
// Stream commands.
        ...
        long long
        Redis::xack(const StringView &key, const StringView &group, const StringView &id) {
        ...
        void
        Redis::xgroup_setid(const StringView &key, const StringView &group, const StringView &id) {
