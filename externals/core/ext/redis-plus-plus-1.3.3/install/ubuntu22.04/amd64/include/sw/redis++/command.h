...
// CONNECTION command.
            ...
            inline void
            auth(Connection &connection, const StringView &user, const StringView &password) {
...
// STRING commands.
            ...
            inline void
            append(Connection &connection, const StringView &key, const StringView &str) {
            ...
            inline void
            incrbyfloat(Connection &connection, const StringView &key, double increment) {
...
// LIST commands.
            ...
            inline void
            lpush(Connection &connection, const StringView &key, const StringView &val) {
            ...
            inline void
            lpushx(Connection &connection, const StringView &key, const StringView &val) {
            ...
            inline void
            rpush(Connection &connection, const StringView &key, const StringView &val) {
            ...
            inline void
            rpushx(Connection &connection, const StringView &key, const StringView &val) {
...
// HASH commands.
            ...
            inline void
            hdel(Connection &connection, const StringView &key, const StringView &field) {
            ...
            inline void
            hexists(Connection &connection, const StringView &key, const StringView &field) {
            ...
            inline void
            hget(Connection &connection, const StringView &key, const StringView &field) {
            ...
            template<typename Input>
            void
            hset_range(Connection &connection, const StringView &key, Input first, Input last) {
                assert(first != last);
...
// HYPERLOGLOG commands.
            ...
            inline void
            pfmerge(Connection &connection, const StringView &destination, const StringView &key) {
...
// GEO commands.
            ...
            inline void
            geohash(Connection &connection, const StringView &key, const StringView &member) {
            ...
            inline void
            geopos(Connection &connection, const StringView &key, const StringView &member) {
...
// Stream commands.
            ...
            void xclaim_range(Connection &connection,
                              ...
                              Input last) {
                CmdArgs args;
                args << "XCLAIM" << key << group << consumer << min_idle_time
            ...
            template<typename Input>
            void
            xdel_range(Connection &connection, const StringView &key, Input first, Input last) {
                CmdArgs args;
            ...
            inline void
            xpending(Connection &connection, const StringView &key, const StringView &group) {
