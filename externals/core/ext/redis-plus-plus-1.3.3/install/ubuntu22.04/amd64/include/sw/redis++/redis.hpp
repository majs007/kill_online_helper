...
// KEY commands.
        ...
        inline bool
        Redis::pexpire(const StringView &key, const std::chrono::milliseconds &timeout) {
        ...
        inline long long
        Redis::wait(long long numslaves, const std::chrono::milliseconds &timeout) {
...
// LIST commands.
        ...
        template<typename Output>
        inline void
        Redis::lrange(const StringView &key, long long start, long long stop, Output output) {
...
// SORTED SET commands.
        ...
        template<typename Output>
        void
        Redis::zrevrange(const StringView &key, long long start, long long stop, Output output) {
        ...
        template<typename Interval, typename Output>
        void
        Redis::zrevrangebyscore(const StringView &key, const Interval &interval, Output output) {
...
// SCRIPTING commands.
        ...
        Result Redis::eval(const StringView &script,
                           ...
                           Args args_first,
                           Args args_last) {
            auto reply = command(cmd::eval<Keys, Args>, script, keys_first, keys_last, args_first,
                                 args_last);
...
// Stream commands.
        ...
        template<typename Input>
        long long
        Redis::xack(const StringView &key, const StringView &group, Input first, Input last) {
        ...
        template<typename Input>
        std::string
        Redis::xadd(const StringView &key, const StringView &id, Input first, Input last) {
        ...
        -> typename std::enable_if<!std::is_convertible<Input, StringView>::value>::type {
            ...
            auto reply = command(cmd::xreadgroup_range<Input>, group, consumer, first, last, count,
                                 noack);
