...
namespace sw {
    ...
    namespace redis {
        ...
        namespace test {
            ...
            void cluster_specializing_test(Test &test, void (Test::*func)(Redis &instance),
                                           Redis &instance) {
                (test.*func)(instance);
            }
            ...
            public:
                ...
                KeyDeleter(RedisInstance &redis, Input first, Input last) : _redis(redis),
                                                                            _keys(first, last) {
                    _delete();
                }
                ...
                KeyDeleter(RedisInstance &redis, const std::string &key) : KeyDeleter(redis,
                                                                                      {key}) {}
