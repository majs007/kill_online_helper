    ...
    namespace redis {
        ...
        namespace test {
            ...
            void KeysCmdTest<RedisInstance>::run() {
                ...
                cluster_specializing_test(*this, &KeysCmdTest<RedisInstance>::_test_randomkey,
                                          _redis);
            ...
            void KeysCmdTest<RedisInstance>::_test_ttl() {
                ...
                auto tp_milli = time_point_cast<milliseconds>(
                        system_clock::now() + milliseconds(100000));
            ...
            void KeysCmdTest<RedisInstance>::_test_scan(Redis &instance) {
                ...
                while (true) {
                    cursor = instance.scan(cursor, "*" + key_pattern + "*", 2,
