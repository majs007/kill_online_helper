        ...
        namespace test {
            ...
            void GeoCmdTest<RedisInstance>::run() {
                ...
                num = _redis.georadius(not_exist_key,
                                       ...
                                       false,
                                       10);
                REDIS_ASSERT(!num || (num && *num == 0),
                             "failed to test georadius with store option");
                ...
                REDIS_ASSERT(with_dist_coord.size() == 3,
                             "failed to test georadius with dist and coord");
                ...
                num = _redis.georadiusbymember(key,
                                               ...
                                               false,
                                               10);
                REDIS_ASSERT(bool(num) && *num == 3,
                             "failed to test georadiusbymember with store option");
